...
:component-name: ca/open-digitisation
//
// MANDATORY. Title of the document. In web format, it appears as a heading of
// level 1. In PDF format, it appears in a title page.
:_title: Mesura gov. digitalitazió oberta
//
// OPTIONAL. Subtitle of the document.
:_subtitle: Programari lliure i desenvolupament àgil de serveis a l’administració pública
//
...
:_summary: Mesura de govern per a la digitalitazió oberta: programari lliure i desenvolupament àgil de serveis a l’administració pública. Pla digital de l’Ajuntament de Barcelona.

//
// MANDATORY. Comma-separated list of terms to help classifying and searching
// the document. In web format, this terms are integrated as SEO enabling
// metadata. In PDF format, they are shown near the other metadata.
:keywords: estàndards digitals ètics, drets digitals, barcelona, ajuntament
//
